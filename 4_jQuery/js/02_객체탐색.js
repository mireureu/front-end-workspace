...
let style2 = {'color': 'gray', 'border': '2px solid'};
...
$('h2').nextAll().css('background-color', 'pink');
// h2 요소 이후부터 p 요소 이전에 모든 형제 요소에 테두리 스타일 : dashed
$('h2').nextUntil('p').css('border-style', 'dashed');
// h2 요소의 이전 형제 요소에 style5 적용하기
$('h2').prev().css(style5);
// h2 요소의 이전에 오는 모든 형제 요소에 배경색 : moccasin 적용하기
$('h2').prevAll().css('background-color', 'moccasin');
// h2 요소 이전부터 p 요소 이후까지의 모든 형제 요소에 글자크기 : 2rem 적용하기
$('h2').siblings().not('p').css('font-size', '2rem');